// from https://github.com/MvEerd/ergogen/blob/mveerd/src/footprints/usbc.js
module.exports = {
    nets: {
        GND: 'GND',
        SHIELD: 'SHIELD',
    ...
    body: p => `
          ...
          (fp_line (start 4.64 6.66) (end 4.64 0) (layer ${p.param.side}.CrtYd) (width 0.15))
          (fp_line (start 4.64 0) (end -4.64 0) (layer ${p.param.side}.CrtYd) (width 0.15))
          ...
          ${p.param.side === 'F' ? `
          (pad "B8" smd rect (at 1.75 7.235 ${p.rot}) (size 0.3 1.15) (layers F.Cu F.Paste F.Mask) ${p.net.SBU2.str})
          ...
          (pad "A8" smd rect (at -1.25 7.235 ${p.rot}) (size 0.3 1.15) (layers F.Cu F.Paste F.Mask) ${p.net.SBU1.str})
          ...
          (pad "A8" smd rect (at 1.25 7.235 ${p.rot}) (size 0.3 1.15) (layers B.Cu B.Paste B.Mask) ${p.net.SBU1.str})
          ...
          (pad "B8" smd rect (at -1.75 7.235 ${p.rot}) (size 0.3 1.15) (layers B.Cu B.Paste B.Mask) ${p.net.SBU2.str})
          `}
