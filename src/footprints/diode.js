module.exports = {
    ...
    (module ComboDiode (layer F.Cu) (tedit 5B24D78E)
        ...
        (pad 1 smd custom (at -1.65 0 ${p.rot}) (size 0 0) (layers B.Cu) ${p.net.to.str} (primitives (gr_line (start 0 0) (end -1.81 0) (width 0.25))))
        (pad 1 smd custom (at -1.65 0 ${p.rot}) (size 0 0) (layers F.Cu) ${p.net.to.str} (primitives (gr_line (start 0 0) (end -1.81 0) (width 0.25))))
        (pad 2 smd custom (at 1.65 0 ${p.rot}) (size 0 0) (layers B.Cu) ${p.net.from.str} (primitives (gr_line (start 0 0) (end 1.81 0) (width 0.25))))
        (pad 2 smd custom (at 1.65 0 ${p.rot}) (size 0 0) (layers F.Cu) ${p.net.from.str} (primitives (gr_line (start 0 0) (end 1.81 0) (width 0.25))))
    )
    `
}
